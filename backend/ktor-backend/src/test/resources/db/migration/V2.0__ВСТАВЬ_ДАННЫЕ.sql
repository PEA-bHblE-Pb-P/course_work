...
INSERT INTO character(id, type_id, name, birthday, history, sex_id, place_of_living_id, location_id, "group", favor_id, photo_url) VALUES
(1, 1, 'Виаго', '1636-03-10', 'Вампир трехсот семидесяти девяти лет от роду, родом из Германии. Денди, помешанный на чистоте и порядке.', 3, 1, 1, 1, 2, 'https://se.ifmo.ru/documents/1609903/1613524/photo_2021-09-17_16-47-58.jpg/f0afb842-d5e5-d0e4-215f-772e7a4312ba?t=1631886833350'),
(2, 1, 'Афанас', '1-01-01', 'У Афанаса нет гениталий, но по словам Ласло и Надьи, которые имели с ним связь, он является превосходным любовником.', 1, null, 2, 1, 1, 'https://se.ifmo.ru/documents/1609903/1613524/photo_2021-09-17_16-48-10.jpg/a706de0d-223a-b180-fcec-9cace7d4b0d4?t=1631887454338');
...
(5, 3, 'Гильермо дель Торо Гомес', '1994-10-09', 'Режиссёр', 3, 1, 1),
(6, 5, 'охотник Гильермо', '1994-10-09', 'Охотник', 3, 1, 4),
(7, 3, 'Иван', '2002-02-02', 'Студент второго курса', 3, 1, 1),
(8, 3, 'Кирилл', '2002-02-02', 'Студент в академе', 3, 1, 1),
(9, 3, 'Татьяна', '1990-09-03', 'Студентка', 2, 1, 2),
(10, 5, 'охотник Бан', '1990-10-09', 'Особенно злой охотник', 3, 1, 4);


INSERT INTO character(id, type_id, name, birthday, history, sex_id, place_of_living_id, location_id, photo_url) VALUES
(11, 3, 'Инга', '2001-11-13', 'Студент', 3, 1, 2, 'https://thispersondoesnotexist.com/image');
